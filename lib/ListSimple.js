...
export default class List extends Component {
    ...
    static propTypes = {
        ...
        leftAvatarHeight: PropTypes.number,
    ...
    render() {
        ...
        const content = (
            <View style={[defaultStyles.listContainer, styles.listContainer, {borderWidth: 0}]}>
                ...
                <View style={[defaultStyles.contentViewContainer, styles.contentViewContainer]}>

                    {
                        (leftIcon || leftAvatar) &&
                        <View
                            style={[defaultStyles.leftViewContainer, styles.leftViewContainer, leftWidth, {borderWidth: 0, height: leftAvatarHeight}]}
                        >
                            {leftIcon &&
                    ...
                    <View style={defaultStyles.textViewContainer}>
                        ...
                        <View style={defaultStyles.firstLine}>
                            <View style={[defaultStyles.primaryTextContainer, {borderWidth: 0}]}>
                        ...
                        {titleMessage && timeMessage &&
                        <View style={defaultStyles.firstLine}>
                            <View style={[defaultStyles.primaryTextContainer, {flex: 3}]}>
                                <Text style={{color: 'black'}}>{titleMessage}</Text>
                            </View>
                            <View style={{flex: 1, alignItems: 'flex-end'}}>
                                <Text style={{fontSize: 8}}>{timeMessage}</Text>
                            </View>
                        </View>
                        }
                    ...
                    <View style={[defaultStyles.rightViewContainer, styles.rightViewContainer, {margin: 0, padding: 0, borderWidth: 0}]}>
                        {rightAvatar &&
                        ...
                        <View style={[defaultStyles.rightIcon, styles.rightIcon, {borderWidth: 0, padding: 0, margin: 0}]} >
                            {
                                menuActions &&
                                <IconToggle
                                    color={primaryColor}
